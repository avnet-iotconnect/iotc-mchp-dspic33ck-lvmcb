...
- `create-device-button.png` / `device-name.png` / `select-entity.png` / `template-select.png` / `use-my-cert.png` -
  device-creation walkthrough in Step 5

Motor-control-board-specific:
...
- `mcsk-connections-flash.png` - board connections for flashing and running the demo (power, PKOB4 USB,
  RNWF11 already mounted), shown in Step 9
